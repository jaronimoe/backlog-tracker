...
**Bulk-add mode:** TBD — paste a list, import from CSV/table, or sync from game recommender's library. To be designed later.
...
**Behavior:**
- **Recently Played** is auto-populated: games played within the last 2 weeks, ordered most-recent-first
